...
ENV APP_ENV=${app_env:-"prod"} \
    ...
    PHPYAF_VERSION=3.0.9 \
    PHP_PHALCON_VERSION=3.4.5 \
    PHP_XDEBUG_V=2.8.0

RUN apt-get update \
    && apt-get install -y --no-install-recommends \
        curl wget vim git zip unzip less procps lsof tcpdump htop openssl supervisor zlibc \
        libz-dev \
        libssl-dev \
        libnghttp2-dev \
        libpcre3-dev \
...
COPY /usr/share/nginx/html/index.html /var/www/html/index.html
